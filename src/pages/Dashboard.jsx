...
export default function Dashboard() {
  ...
  return (
    <div style={{
      ...
      <Sidebar activeSubject={activeSubject} onSelectSubject={handleSelectSubject} />
      ...
      <div style={{ flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        ...
        <header style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 13 }}>
            <span style={{ color: t.t20 }}>S6 Exams</span>
            ...
            {subject ? (
              <>
                ...
                {modMeta ? (
                  <>
                    <ChevronRight size={12} color={t.t12} />
                    <span style={{ color: t.t40 }}>Module {activeModule}</span>
                  </>
                ) : (
                  <>
                    <ChevronRight size={12} color={t.t12} />
                    <span style={{ color: t.t40 }}>{subject.name}</span>
                  </>
                )}
              </>
            ) : (
